...
**Input**: ../out/gap/passthrough.vcf
**Rarity threshold**: population AF < 0.01

## 2 rare high-impact variants carried

Of 68 carried, annotated variants, 29 are high-impact (loss-of-function). Of those:

- **2 rare** with documented population frequency below 0.01 (ultra-rare AF < 0.001: 2; rare: 0)
- 26 common (documented AF at or above the threshold)
...
|------|-------|-------------|----------|---------------|---------|
| DDX56 | 7:44610376 G>A | stop_gained | het | 3e-05 | - |
| FAM218A | 4:165878621 G>A | stop_gained | het | 9e-05 | - |
